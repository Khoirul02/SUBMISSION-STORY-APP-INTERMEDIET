...
class ImageBannerWidget : AppWidgetProvider() {
    companion object {
        private const val TOAST_ACTION = "com.submission.huda.storyapps.ui.widget.TOAST_ACTION"
        const val EXTRA_ITEM = "com.submission.huda.storyapps.ui.widget.EXTRA_ITEM"
