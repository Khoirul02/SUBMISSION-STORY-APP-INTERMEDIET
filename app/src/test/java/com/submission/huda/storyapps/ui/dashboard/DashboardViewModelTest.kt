...
class DashboardViewModelTest{
    ...
    @Test
    fun `when Get Story Should Not Null Return Success`() = runTest {
        val data: PagingData<ListStoryItem> = StoryPangingSource.snapshot(dummyStory)
        val expectedStory = MutableLiveData<PagingData<ListStoryItem>>()
        expectedStory.value = data
        Mockito.`when`(storyRepository.listStoryPage("")).thenReturn(expectedStory)
        val actualStory: PagingData<ListStoryItem> = dashboardViewModel.getAllStory("").getOrAwaitValue()
...
class StoryPangingSource : PagingSource<Int, LiveData<List<ListStoryItem>>>() {
    companion object {
